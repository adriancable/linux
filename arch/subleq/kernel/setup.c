...
/*
 * The global current task pointer, used by the 'current' macro.
 * Initialized to &init_task here; updated by __switch_to on every
 * context switch.
 */
struct task_struct *volatile __current_task = &init_task;
EXPORT_SYMBOL(__current_task);
/*
 * The offset of task_struct::stack is generated by asm-offsets.c as TASK_STACK.
 * With CONFIG_THREAD_INFO_IN_TASK, thread_info is embedded at offset 0 of
 * task_struct, shifting stack to a later offset.
 */
